//Code comes from nachos.sh@Berkeley.
//Please add this source Java code to nachos.sh.thread package (copy this file to nachos.sh/threads/).
...
public final class PrioritySchedulerTest {
     ...
     *  only pass if PriorityScheduler is set as the Machine's scheduler in nachos.sh.conf
     */
