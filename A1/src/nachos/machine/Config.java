...
public final class Config {
    ...
    /**
     * Get the value of a key in <tt>nachos.sh.conf</tt>.
     *
    ...
    /**
     * Get the value of a key in <tt>nachos.sh.conf</tt>, returning the specified
    ...
    /**
     * Get the value of an integer key in <tt>nachos.sh.conf</tt>.
     *
     * @param    key    the key to look up.
    ...
    /**
     * Get the value of an integer key in <tt>nachos.sh.conf</tt>, returning the
    ...
    /**
     * Get the value of a double key in <tt>nachos.sh.conf</tt>.
     *
     * @param    key    the key to look up.
     * @return the value of the specified key.
     */
    ...
    /**
     * Get the value of a double key in <tt>nachos.sh.conf</tt>, returning the
     * specified default if the key does not exist.
     *
     * @param    key        the key to look up.
     * @param    defaultValue    the value to return if the key does not exist.
    ...
    /**
     * Get the value of a boolean key in <tt>nachos.sh.conf</tt>.
     *
     * @param    key    the key to look up.
     * @return the value of the specified key.
     */
    ...
    /**
     * Get the value of a boolean key in <tt>nachos.sh.conf</tt>, returning the
     * specified default if the key does not exist.
     *
     * @param    key        the key to look up.
     * @param    defaultValue    the value to return if the key does not exist.
